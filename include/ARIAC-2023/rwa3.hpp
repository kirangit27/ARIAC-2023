...
{
    public:
        CompetitionARIAC() : Node("competition_subscriber"),floor_robot_(std::shared_ptr<rclcpp::Node>(std::move(this)), "floor_robot"),planning_scene_()
        {
    ...
    private:
        ...
        /*!< Subscriber to camera image over conveyor */
        // rclcpp::Subscription<ariac_msgs::msg::AdvancedLogicalCameraImage>::SharedPtr conv_camera_pick_sub_;
